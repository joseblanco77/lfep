...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-3 logo">
                    <a href="{{ route('home') }}">
                        <img src="{{ asset('lfep/imgs/logo.jpg') }}" alt="">
                    </a>
                </div>
    ...
    <main role="main">
        @include('pagelets.slide') @yield('content')
        <section id="askAnything">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h1>¿Tienes preguntas o un evento de parejas o familiar?</h1>
                        <h2>Puedes enviar tus consultas o invitaciones a conferencias familiares a:
                            <a href="mailto:programa&#x40;lafamiliaesprioridad.com">programa&#x40;lafamiliaesprioridad.com</a>, llena nuestro
                            <a href="{{ route('cajaverde.contacto') }}">fomulario de contacto</a> o
                            <a href="https://www.facebook.com/victor.suchite" target="_blank">encuéntranos en Facebook</a>
                        </h2>
                    </div>
                </div>
            </div>
